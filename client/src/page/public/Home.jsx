  ...
  return (
    <div className="">
      ...
      <div className="lg:h-screen bg-color lg:flex lg:items-center overflow-clip">
        <div className="lg:w-1/2 flex-shrink-0 text-white pt-32 px-10 lg:pl-48 ">
          <h1 className="text-4xl lg:text-6xl font-bold mb-6">
            Discover best in class books here
          </h1>
          <p className="font-semibold text-gray-500 text-sm lg:text-lg mb-10 lg:mb-3">
            Find the best, reliable and affordable books here. We focus on the
            book quality. Here you can find all the books ever made. Even the
            books officially stopped selling. So why you are waiting? Just order
            now!
          </p>
        ...
        <img
          src={BgImage}
          className="lg:w-[800px] lg:-ml-12 lg:mt-16"
          alt="Bg Image"
        />
      </div>
      {/* ---------- New Collections  ---------*/}
      ...
      <div className="bg-black text-white text-center">
        <h1 className="text-5xl font-bold pt-32">Book Share Hub</h1>
        <p className="text-sm lg:text-xl mt-8 font-bold">
          From ₹100 to ₹100,000 Every Book Ever Published
        </p>
