...
import { getPublishers } from "../../../../redux/actions/admin/customerAction";
...
const Publishers = () => {
  ...
  useEffect(() => {
    dispatch(getPublishers(searchParams));
    const params = new URLSearchParams(window.location.search);
    ...
    <>
      ...
      <div className="p-5 w-full overflow-y-auto text-sm">
        ...
        <div className="flex justify-between items-center font-semibold">
          <div>
            <h1 className="font-bold text-2xl">Publishers</h1>
            <div className="flex items-center gap-2 mt-2 mb-4 text-gray-500">
              <p className="text-blue-500 font-semibold">Dashboard</p>
              <span>
                <BsCaretRightFill />
              </span>
              <p className="font-semibold">Publishers List</p>
            </div>
          </div>
        </div>
