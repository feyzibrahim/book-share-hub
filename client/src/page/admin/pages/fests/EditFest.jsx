...
import { editFest } from "../../../../redux/actions/admin/festsAction";
  ...
  useEffect(() => {
    const loadInitialData = async () => {
      try {
        ...
        const festData = response.fest;
        const formattedStartDate = festData.start_date
          ? festData.start_date.slice(0, 10)
          : "";
        const formattedEndDate = festData.end_date
          ? festData.end_date.slice(0, 10)
          : "";
        ...
        if (festData) {
          setInitialValues({
            ...
            location: {
              address: festData?.location?.address ?? "",
              city: festData?.location?.city ?? "",
              country: festData?.location?.country ?? "",
            },
    ...
    <>
      ...
      <div className="p-5 w-full overflow-y-scroll">
        ...
        <div className="flex justify-between items-center text-sm font-semibold">
          <div>
            <h1 className="font-bold text-2xl">Edit Fest</h1>
            {/* Bread Crumbs */}
