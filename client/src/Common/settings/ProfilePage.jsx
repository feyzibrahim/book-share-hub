...
import InputWithIcon from "../../page/user/components/InputWithIcon";
import { getPassedDateOnwardDateForInput } from "../functions";
import ProfileImage from "../../components/ProfileImage";
import Modal from "../../components/Modal";
import EditProfile from "../../page/user/components/EditProfile";
...
const ProfilePage = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white mt-2 rounded-lg w-full mx-5 lg:mx-0">
